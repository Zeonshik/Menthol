...
public class ApplicationLoader extends Application {
    ...
    public static void postInitApplication() {
        ...
        for (int a = 0; a < UserConfig.MAX_ACCOUNT_COUNT; a++) { //TODO improve account
            ...
            if (a == 0) {
                SharedConfig.pushStringStatus = "__FOREGROUND_SERVICE_PUSH__";
            } else {
    ...
    public void onCreate() {
        ...
        AndroidUtilities.runOnUIThread(ApplicationLoader::startPushService, 3500);
        AndroidUtilities.runOnUIThread(MentholVpnAutostart::startDefault, 1500);
    ...
    public static void startPushService() {
        ...
        preferences.edit().putBoolean("pushService", false).apply();
        mainSettings.edit().putBoolean("keepAliveService", false).apply();
        try {
