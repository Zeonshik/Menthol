...
public class MessageObject {
    ...
    public boolean updateTranslation(boolean force) {
        ...
        if (
            ...
            if (translatedText != null) {
                if (manually) {
                    String original = messageOwner.voiceTranscriptionOpen ? messageOwner.voiceTranscription : messageOwner.message;
                    if (original == null) {
                        original = "";
                    }
    ...
    public boolean isSavedDeleted() {
        return messageOwner != null && messageOwner.savedDeleted;
    }
...
//        }
    ...
    public boolean canForwardMessage() {
        ...
        return !(messageOwner instanceof TLRPC.TL_message_secret) && !needDrawBluredPreview() && !isLiveLocation() && type != MessageObject.TYPE_PHONE_CALL && !isSponsored() && !messageOwner.noforwards && !isSavedDeleted();
    }
