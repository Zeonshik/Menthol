...
public class EmojiThemes {
    ...
    public static void saveCustomTheme(Theme.ThemeInfo themeInfo, int accentId) {
        ...
        if (themeInfo.getKey().equals("Blue") && (accentId == 9 || accentId == 99)) {
            return;
        }
        if (themeInfo.getKey().equals("Day") && accentId == 9) {
            return;
        }
        if (themeInfo.getKey().equals("Night") && (accentId == 9 || accentId == 0)) {
            return;
        }
        if (themeInfo.getKey().equals("Dark Blue") && (accentId == 15 || accentId == 0)) {
            return;
        }
