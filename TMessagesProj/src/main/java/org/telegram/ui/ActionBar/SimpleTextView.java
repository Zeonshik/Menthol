...
//            textWidth = (int) Math.ceil(layout.getLineWidth(0));
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if ((rightDrawableOnClickListener != null && rightDrawable != null) || (rightDrawable2OnClickListener != null && rightDrawable2 != null)) {
            boolean inRightDrawable = false;
            boolean inRightDrawable2 = false;
            if (rightDrawableOnClickListener != null && rightDrawable != null) {
                ...
                inRightDrawable = AndroidUtilities.rectTmp.contains((int) event.getX(), (int) event.getY());
            }
            if (!inRightDrawable && rightDrawable2OnClickListener != null && rightDrawable2 != null) {
                AndroidUtilities.rectTmp.set(rightDrawable2X - dp(16), rightDrawable2Y - dp(16), rightDrawable2X + dp(16), rightDrawable2Y + dp(16));
                inRightDrawable2 = AndroidUtilities.rectTmp.contains((int) event.getX(), (int) event.getY());
            }
            if (event.getAction() == MotionEvent.ACTION_DOWN && (inRightDrawable || inRightDrawable2)) {
                maybeClick = true;
                maybeClickDrawable2 = inRightDrawable2;
