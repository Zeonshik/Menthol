...
import org.telegram.tlrpc.models.TlRulesConfig
...
abstract class GenerateSchemeTask : DefaultTask() {
    ...
    fun generate() {
        ...
        val tlSchemaFilter = tlSchemaFull.applyRules(TlRulesConfig.rules)
        ...
        val dep = TlRulesConfig.rules.databaseTypes
    ...
    private fun generateSchemeClassForType(
        ...
        for (constructor in constructors) {
            ...
            if (!TlRulesConfig.rules.filterConstructor(constructor.tl.key.name)) continue
